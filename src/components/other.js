...
const Login = ({onLogin}) => {
 ...
 useEffect(() =>{
  ...
  return (
    <div className='login'>
    {/* {isLoggedIn && <p>You are logged In <button onClick={signOut}>Log Out</button></p> } */}
      ...
      <div className='login-container'>
        ...
        <form>
          <h5>Email</h5>
          <input type='text' ref={state.emailValue} onChange={emailChangeHandler}/>
          <h5>Password</h5>
          <input type='Password'  ref={state.passwordValue} onChange={passwordChangeHandler}/>
